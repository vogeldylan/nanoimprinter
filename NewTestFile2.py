            ...
            if (inputStatus == True):
                ...
                try:
                    ...
                    while working:
                        ...
                        if ((limited[0][0] == False) and ((self.process.temp - self.process.t_center_avg) < 15)):
                        ...
                        if ((limited[1][0] == False) and ((self.process.temp - self.process.t_edge_avg) < 15)):
                        ...
                        if ((limited[0][1] == False) and ((self.process.temp - self.process.t_center_avg) < 1)):
                        ...
                        if ((limited[1][1] == False) and ((self.process.temp - self.process.t_edge_avg) < 1)):
